function func_dataset_01_preproc2P_trainedBasis(preproc2P_stamp)
...
opt.init_model = 'neurofinder_preproc2P'; %'donut_four'; %'donut_conv'; %{'donut_conv', 'pointlike'};%{'donut_four', 'pointlike'}; %'donut_two'; %'donut_conv'; %'pointlike'; %'filled'; %{'filled', 'donut'};
...
opt.cells_per_image = 5; % very few cells as we just set this up to learn the initial basis
