...
if do_figure_exports
  ...
  fig_timestamp = '_20190608T182030';
...
if do_figure_exports, f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_mean_green'); end

my_new_figure_image(5); clf; imagesc(model.opt.cumulant_pixelwise{2}); axis image; axis off; colorbar; colormap(my_colormaps.fire)
if do_figure_exports, f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_var_red'); end
...
if do_figure_exports, f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_spatial_gain'); end
...
if do_figure_exports, f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_mean_uncorr'); end
...
if do_figure_exports, f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_var_uncorr'); end
...
%   hold on; rectangle('Position',[-2,-2,length(cur_area_inds{2})+5,length(cur_area_inds{1})+5], 'EdgeColor','k','Linewidth',1.);
  ...
  if do_figure_exports, f_set_axis_props(gca); f_export_fig(['fig_ch2_final_example_01_data_01_results_image_zoom_' num2str(i1)]); end
...
figure(4);
if do_figure_exports, f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_mean_green_zoombox'); end
figure(5);
if do_figure_exports, f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_var_red_zoombox'); end
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_mean_zoom'); end
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_variance_zoom'); end
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_variance_vert_zoom_line'); end
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_line_vert_variance_plot'); end
...
line_covar_reconst = full_reconst_covmat(logical(patch_mask_outer(:)));
line_covar_resid = line_covar - line_covar_reconst;


line_covar = reshape(line_covar,sum(patch_mask(:)),sum(patch_mask(:)));
line_covar_reconst = reshape(line_covar_reconst,sum(patch_mask(:)),sum(patch_mask(:)));
line_covar_resid = reshape(line_covar_resid,sum(patch_mask(:)),sum(patch_mask(:)));
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_line_vert_covariance_image_raw_noclim'); end
my_new_figure_image(102); clf; imagesc(line_covar, clim_covar); colormap(cur_colormap); axis image; colorbar
if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_line_vert_covariance_image_raw'); end
...
% Do reconstruction images
clim_reconst = [-1e6,6e6];
my_new_figure_image(11021); clf; imagesc(gauss_smooth_matrix(line_covar,0,1.,1.),clim_reconst); colormap(cur_colormap); colorbar; axis image
my_new_figure_image(11022); clf; imagesc(gauss_smooth_matrix(line_covar_reconst,0,1.,1.),clim_reconst); colormap(cur_colormap); colorbar; axis image
my_new_figure_image(11023); clf; imagesc(gauss_smooth_matrix(line_covar_resid,0,1.,1.),clim_reconst); colormap(cur_colormap); colorbar; axis image


cell_locs = {[6,22], [10,30]};
cur_border_colors = {'m','b'};
for cell1 = 1:length(cell_locs)
  for fignum = [1021,11021,11022,11023]
  ...
  line([45-cell1,45-cell1],cell_locs{cell1}, 'LineWidth', 2., 'Color', cur_border_colors{cell1} )
end


% Save the images with the appropriate boxes
figure(1021); if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_line_vert_covariance_image_processed'); end
figure(11021); if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_line_vert_covariance_image_orig_processed'); end
figure(11022); if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_line_vert_covariance_image_reconst_processed'); end
figure(11023); if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_line_vert_covariance_image_resid_processed'); end




figure(100+mom1*10+1);
if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_variance_vert_zoom_line_colored'); end
...
% Show reconstruction and residual
%my_new_figure_image(11022); clf; imagesc(gauss_smooth_matrix(line_covar,1.2,1.,1.),clim_covar); colormap(cur_colormap); colorbar; axis image
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_variance_horiz_zoom_line'); end
...
xlabel('Y-Location (pixel)')
f_set_axis_props(gca);
if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_line_horiz_variance_plot'); end
...
my_new_figure_image(102); clf; imagesc(line_covar); colormap(cur_colormap); axis image; colorbar
if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_line_horiz_covariance_image_raw_noclim'); end
my_new_figure_image(102); imagesc(line_covar, clim_covar); colormap(cur_colormap); axis image; colorbar;
if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_line_horiz_covariance_image_raw'); end
%my_new_figure_image(1021); clf; imagesc(gauss_smooth_matrix(line_covar,1.2,1.,1.),clim_covar); colormap(cur_colormap); colorbar; axis image
...
% Do reconstruction images
clim_reconst = [-1e6,6e6];
my_new_figure_image(11021); clf; imagesc(gauss_smooth_matrix(line_covar,0,4.,1.),clim_reconst); colormap(cur_colormap); colorbar; axis image
my_new_figure_image(11022); clf; imagesc(gauss_smooth_matrix(line_covar_reconst,0,4.,1.),clim_reconst); colormap(cur_colormap); colorbar; axis image
my_new_figure_image(11023); clf; imagesc(gauss_smooth_matrix(line_covar_resid,0,4.,1.),clim_reconst); colormap(cur_colormap); colorbar; axis image
...
figure(1021);
if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_line_horiz_covariance_image_processed'); end
figure(11021); if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_line_horiz_covariance_image_orig_processed'); end
figure(11022); if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_line_horiz_covariance_image_reconst_processed'); end
figure(11023); if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_line_horiz_covariance_image_resid_processed'); end

figure(100+mom1*10+1);
if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_variance_horiz_zoom_line_colored'); end
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_variance_XYfalloff'); end
...
my_new_figure_image(100+mom1*10+1); clf; imagesc(opt.cumulant_pixelwise{mom1}(inds{1},inds{2})); axis image; colorbar; colormap(cur_colormap)
%if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_variance_zoom_box'); end
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_box_covariance_image_raw_noclim'); end
my_new_figure_image(103); clf; imagesc(box_covar, clim_covar); colormap(cur_colormap); colorbar; axis image 
if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_box_covariance_image_raw'); end
...
figure(103);
if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_box_covariance_image_processed'); end

figure(100+mom1*10+1);
if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_variance_zoom_box_colored'); end
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_higher_ex_mom1'); end
my_new_figure_image(712); imagesc(xcums{2}(xcum_subind,xcum_subind)); axis image; colorbar; colormap(cur_colormap)
if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_higher_ex_mom2'); end
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_higher_ex_mom3'); end
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig_raster('fig_ch2_final_example_01_data_01_preproc_higher_ex_mom4'); end
...
% if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_skewness_uncorr'); end
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_skewness'); end
...
% if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_kurtosis_uncorr'); end
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_final_example_01_data_01_preproc_kurtosis'); end
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_data_01_example_variance_zoom_line_horiz'); end
