...
if do_figure_exports
  ...
  fig_timestamp = '_20190607T144215';
...
gitsha = 'gitsha_2bd0d72_evalgit_db4ade8_noimpute';
...
chomp_iter = '2'; % Different iters are with different settings!
chomp_timestamp ='20190607T192326'; % new try full covar only noimpute
...
if do_figure_exports,f_set_axis_props(gca); f_export_fig('fig_ch2_data_02_results_curve'); end
