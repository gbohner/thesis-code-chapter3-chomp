...
if do_figure_exports, figure(5); f_set_axis_props(gca); f_export_fig('fig_ch2_data_01_results_image_main'); end
...
if do_figure_exports, figure(5); f_set_axis_props(gca); f_export_fig('fig_ch2_data_01_results_image_main_morecells'); end
