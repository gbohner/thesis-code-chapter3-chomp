function [out_timestamp, saved_opts] = func_dataset_04_01_preproc2P(preproc2P_stamp, input_opts)
...
opt.data_path = [...
  '/nfs/data/gergo/Neurofinder_update/neurofinder.04.01' ...
...
% Set the new data paths
opt.data_path = [...
  '/nfs/data/gergo/Neurofinder_update/neurofinder.04.01.test' ...
  '/preproc2P/images' preproc2P_stamp ...
  '/image00001.tif'];
% Set the subfolders names - neurofinder specific
opt.input_folder = [fileparts(fileparts(opt.data_path)) '/CHOMP/input/'];
