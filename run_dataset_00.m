...
opt.data_path = '/nfs/data/gergo/Neurofinder_update/neurofinder.00.00/images/image00001.tiff';
...
opt.init_model = 'pointlike'; %'donut_conv'; 'pointlike'; %'filled'; %{'filled', 'donut'};
opt.niter = 7;
...
% Set the new data paths
opt.data_path = '/nfs/data/gergo/Neurofinder_update/neurofinder.00.00.test/images/image00001.tiff';
% Set the subfolders names - neurofinder specific
opt.input_folder = [fileparts(fileparts(opt.data_path)) '/CHOMP/input/'];
opt.output_folder = [fileparts(fileparts(opt.data_path)) '/CHOMP/output/'];
opt.results_folder = [fileparts(fileparts(opt.data_path)) '/CHOMP/results/'];
...
% Set the new data paths
opt.data_path = '/nfs/data/gergo/Neurofinder_update/neurofinder.00.01.test/images/image00001.tiff';
% Set the subfolders names - neurofinder specific
opt.input_folder = [fileparts(fileparts(opt.data_path)) '/CHOMP/input/'];
opt.output_folder = [fileparts(fileparts(opt.data_path)) '/CHOMP/output/'];
opt.results_folder = [fileparts(fileparts(opt.data_path)) '/CHOMP/results/'];
