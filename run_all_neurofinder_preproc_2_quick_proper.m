...
input_opts.local_peaks_size = [13,6,0];
input_opts.local_peaks_gauss = 2.5;
input_opts.blank_reconstructed = 0;
input_opts.spatial_push = @(x)1.*(x>=4);
...
savename = ['./Examples/saved_runs_neurofinder_preproc_2_quick_proper' cur_timestamp '.mat'];
