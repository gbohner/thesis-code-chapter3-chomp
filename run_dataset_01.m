...
%opt.spatial_push = [];
%opt.spatial_push = @(grid_dist)1.0*(grid_dist>=(2opt.m/3)); % For inference, be less restrictive on spatial push
...
% Set the new data paths
opt.data_path = '/nfs/data3/gergo/Neurofinder_update/neurofinder.01.00.test/images/image00001.tiff';
% Set the subfolders names - neurofinder specific
opt.input_folder = [fileparts(fileparts(opt.data_path)) '/CHOMP/input/'];
opt.output_folder = [fileparts(fileparts(opt.data_path)) '/CHOMP/output/'];
opt.results_folder = [fileparts(fileparts(opt.data_path)) '/CHOMP/results/'];
...
opt.learn = 0;
% Set the new data paths
opt.data_path = '/nfs/data3/gergo/Neurofinder_update/neurofinder.01.01.test/images/image00001.tiff';
% Set the subfolders names - neurofinder specific
opt.input_folder = [fileparts(fileparts(opt.data_path)) '/CHOMP/input/'];
opt.output_folder = [fileparts(fileparts(opt.data_path)) '/CHOMP/output/'];
opt.results_folder = [fileparts(fileparts(opt.data_path)) '/CHOMP/results/'];
